...
} from "../../redux-store/App/AppActions.js";
            ...
            <section className="profile-section">
              ...
              <div id="profile-cards">
                ...
                <div className="profileCard" style={{ marginBottom: "2%" }}>
                  <h4>
                    Github:{" "}
                    <a href={props.currentUser.github_url}>
                      {props.currentUser.github_url}
                    </a>
                  </h4>
                  <h4>
                    LinkedIn:{" "}
                    <a href={props.currentUser.linkedin_url}>
                      {props.currentUser.linkedin_url}
                    </a>
                  </h4>
                  <h4>
                    Resume:{" "}
                    <a href={props.currentUser.resume}>
                      {props.currentUser.resume}
                    </a>
                  </h4>
                  <h4>
                    Portfolio:{" "}
                    <a href={props.currentUser.portfolio_url}>
                      {props.currentUser.portfolio_url}
                    </a>
                  </h4>
                </div>
                <div className="profileCard">
                    ...
                    <div className="profile-form-edit-name">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder={props.currentUser.first_name}
                        />
                      </div>
                      <div>
                        <h3>Last Name</h3>
                        <input
                          ...
                          name="last_name"
                          onChange={handleChange}
                          placeholder={props.currentUser.last_name}
                        />
                      </div>
                    </div>
                    <div>
